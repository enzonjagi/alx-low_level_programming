...
int main(void)
{
	...
	if (x > 5)
	printf("%s %lu is %d and is greater than 5", begin, (long int)n, x);
	else if (x == 0)
	printf("%s %lu is %d and is 0", begin, (long int)n, x);
	else if ((x < 6) && (x != 0))
	printf("%s %lu is %d and is less than 6 and not 0", begin, (long int)n, x);
	return (0);
}
